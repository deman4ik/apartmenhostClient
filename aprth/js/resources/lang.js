...
var langs = [
	...
	//русский
	{
		...
		SRV_CARD_PHONE_UNCONF: "У данного объявление пока не подтвердили телефон, бронирование не доступно!",
		SRV_PROFILE_PHONE_UNCONF: "Вы не можете добавить объявление пока не подтвердили свой телефон!",
	...
	//английский
	{
		...
		SRV_PROFILE_PHONE_UNCONF: "You can't book this card, because the owner has not confirmed his phone yet!",
