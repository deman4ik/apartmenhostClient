...
var langs = [
	...
	//русский
	{
		...
		UI_FOOTER_MENU_SOCIAL_OK: "Odnoklassniki",		
		...
		UI_TITLE_UNSUBSRSC_CONFIRM: "Подтверждение отписки",
		...
		UI_TITLE_SET_EMAIL: "Укажите e-mail",
		...
		UI_FLD_APARTMENT_DESC: "Описание жилья и условий содержания питомца",
		UI_FLD_EXTRA_MANDATORY: "Несколько уточняющих вопросов",
		UI_FLD_EXTRA_OPTIONAL: "Вспомогательная информация",
		UI_FLD_RENT_EXTRA: "Дополнительно",
		UI_FLD_GENDER: "Пол",
		UI_FLD_MAIL: "Почта",
		UI_FLD_ABOUT_ME: "О себе",
		UI_FLD_PHOTO: "Фото жилья",
		...
		UI_LBL_FILTER_RESULT: "Найдено предложений %1$s (отображено - %2$s)",
		...
		UI_LBL_MAIN_MAKE_ACTION: "Найдите зооняню",
		UI_LBL_MAIN_AND_BE_OK: "Передержка для Вашего питомца на время отпуска или командировки",
		UI_LBL_MAIN_OR: "или",
		UI_LBL_MAIN_TRY_ANOTHER_ACTION: "Найди себе новое!",
		UI_LBL_PHONE_CONFIRMED: "Подтвержден",
		UI_LBL_EMAIL_NOTIFICATIONS: "Получать оповещения",
		UI_LBL_EMAIL_NEWS_LETTERS: "Получать новости",
		UI_NOTE_PHONE: "Телефон Вашего профиля.",
		UI_NOTE_UNAVAILABLE: "Отметьте дни, в которые Вы не сможете принять питомцев",
		UI_NOTE_EXTRA_MANDATORY: "Они помогут хозяевам быстрее найти Ваше объявление выбрав соответствующие фильтры при поиске",
		UI_NOTE_EXTRA_OPTIONAL: "Необязательно для заполнения, эта информация появятся на вашей анкете как дополнительные сведения",
		UI_NOTE_RENT_EXTRA: "Кратко через запятую перечислите дополнительные услуги: доставка питомца, стрижка, услуги ветеринара, покупка корма и т.д.",
		...
		UI_NOTE_PHOTO: "Загрузите актуальные фото Вашего жилья для большей эффективности объявления; нажмите на фото, чтобы сделать его основным",
		UI_NOTE_PASS: "Не менее 8-ми символов",
		...
		DVAL_OWNER: "Мне",
		DVAL_RENTER: "От меня",
		// ресурсы для описания списков - дополнительные логические/бинарные признаки в анкете ситтера
		EXI_MULTIPLE_PETS: "Есть собственные питомцы / принимаю параллельно питомцев от нескольких хозяев",
		EXI_DELIVERY: "Осуществляю доставку питомцев от хозяина и обратно",
		EXI_NON_STERILIZED: "Принимаю нестерилизованных питомцев",
		EXI_NON_VACCINATED: "Принимаю питомцев без прививок",
		EXI_SPECIAL_FOOD: "По желанию хозяина готовлю специальную еду питомцам",
		EXI_FULL_SURVEY: "Круглосуточный присмотр за питомцем (нахожусь большую часть времени дома)",
		EXI_MEDIA_REPORT: "Предоставляю фото или видео-отчет (skype, whatsapp, viber, и т.д.)",
		EXI_CONTRACT: "Заключаю договор с хозяином",
		EXI_BUY_FOOD: "Покупаю корм, наполнитель и другие сопустсвующие материалы на средства хозяина",
		EXI_VET_SERVICE: "Оказываю ветеринарные услуги",
		EXI_VET_PASSPORT: "Прошу хозяина предоставить ветеринарный паспорт",		
	    ...
	    SRV_LOGIN_NO_PASS: "Пароль не установлен. Воспользуйтесь функцией восстановления пароля.",
		SRV_APARTMENT_REQUIRED: "Не заполнено обязательное поле \"%1$s\"!",
		...
		SRV_REG_INVALID_PASSWORD: "Некорректный пароль (должен содержать 8 или более символов)!",
		...
		SRV_USER_REQUIRED: "Не заполнено обязательное поле \"%1$s\"",
		...
		SRV_PROFILE_WRONG_PHONE: "Телефон указан некорректно!",
		...
		CLNT_COMMON_SUCCESS: "Спасибо",
		CLNT_COMMON_DONE: "Операция выполнена успешно",
		CLNT_COMMON_PROGRESS: "Загрузка данных...",
		CLNT_COMMON_CONFIRM: "Подтвердите действие",
		CLNT_COMMON_CONFIRM_REMOVE: "Вы действительно хотите удалить объявление?",
		...
		CLNT_BOOKING_NO_DATES: "Не указаны даты бронирования и/или вид питомца!",
		CLNT_NO_ADVERTS: "У Вас нет объявления, создайте свое объявление и зарабатывайте на передержке",
		CLNT_NO_ADVERTS_VIEW: "Пользователь ещё не создал объявление",
		CLNT_ADVERTS_VIEW_TITLE: "Объявления пользователя",
		CLNT_COMPLAINT_ADDED: "Спасибо за помощь",		
		CLNT_ADVER_NO_PHONE: "Необходимо указать телефон, чтобы хозяева питомцев могли связаться с Вами!",
		...
		CLNT_PRICE_CATEGORY_APPEND_ERR: "Невозможно добавить питомца и цену: поля не заполнены или заполнены некорректно!",
		CLNT_PRICE_CATEGORY_CALC_ERR: "Выберите вид питомца и даты:",
	...
	//английский
	{
		...
		UI_TITLE_UNSUBSRSC_CONFIRM: "Unsubscription confirm",
		...
		UI_FLD_EXTRA_MANDATORY: "Several important questions",
		UI_FLD_EXTRA_OPTIONAL: "Additional information",
		...
		UI_LBL_FILTER_RESULT: "Adverts found %1$s (%2$2 displayed)",
		UI_LBL_FROM: "from",
		...
		UI_LBL_EMAIL_NOTIFICATIONS: "Recieve notifications",
		UI_LBL_EMAIL_NEWS_LETTERS: "Recieve news letters",
		UI_NOTE_PHONE: "Your profile's phone number.",
		UI_NOTE_UNAVAILABLE: "Set days, when your apartment is unavalable.",
		UI_NOTE_EXTRA_MANDATORY: "This will allow owners to find your announcement faster",
		UI_NOTE_EXTRA_OPTIONAL: "Optional information that will be shown in your announcement",
		...
		DVAL_RENTER: "From me",
		// ресурсы для описания списков - дополнительные логические/бинарные признаки в анкете ситтера
		EXI_MULTIPLE_PETS: "I have my own pets / I accept pets from multiple owners",
		EXI_DELIVERY: "I devlive a pet from/to the owner",
		EXI_NON_STERILIZED: "I accept non-sterilized pets",
		EXI_NON_VACCINATED: "I accept non-vaccinated pets",
		EXI_SPECIAL_FOOD: "I can cook special meal upon request from the owner",
		EXI_FULL_SURVEY: "I can look after a pet 24/7 (I spend most of the time at home)",
		EXI_MEDIA_REPORT: "I can provide owner with photo/video reports (skype, whatsapp, viber, etc.)",
		EXI_CONTRACT: "I sing contract with owner",
		EXI_BUY_FOOD: "I can buy pet food, litter and other supplies at the owner expense",
		EXI_VET_SERVICE: "I can provide a veterinary service",
		EXI_VET_PASSPORT: "I request owner to show me the veterinary passport",	
		//ресурсы для серверных сообщений об ошибках и информации
		...
		SRV_LOGIN_NO_PASS: "No password! Use password recovery.",
		...
		CLNT_PRICE_CATEGORY_CALC_ERR: "Set pet type and dates",
		...
		CLNT_UNSUBSCR_DONE_NOTIFICATIONS: "Unsubscription from notifications successfull!",
		CLNT_UNSUBSCR_DONE_NEWSLETTERS: "Unsubscription from news letters successfull!",
		CLNT_NO_SUBSRC_TYPE: "No unsubscription parameters!",
		CLNT_UNSUBSCR_NOTIFICATIONS: "Unsubscribe from service notifications?",
		CLNT_UNSUBSCR_NEWSLETTERS: "Unsubscribe from news letters?",
		//загрузчик картинок
